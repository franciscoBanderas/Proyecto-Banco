...
public class TestBanco {
	...
	public static void main(String[] args) {
		...
		/* Antonio y Beatriz vuelven a consultar su saldo para
comprobar que todo ha ido bien */
		...
		/* Antonio y Beatriz consultan de nuevo el saldo de su
cuenta. */
		System.out.println(El_saldo_de +
				cuentaAntonio.getCliente().getNombre() + " tiene "
				+ cuentaAntonio.getSaldo() + " euros.");
		System.out.println(El_saldo_de +
				cuentaBeatriz.getCliente().getNombre() + " tiene "
				+ cuentaBeatriz.getSaldo() + " euros.");
		/* Antonio transfiere 50€ a Beatriz y vuelven a consultar el
saldo de su cuenta */
		cuentaAntonio.setSaldo(cuentaAntonio.getSaldo() - 50);
		cuentaBeatriz.setSaldo(cuentaBeatriz.getSaldo() + 50);
		System.out.println(El_saldo_de +
